...
**Triton kernel fusion for Qwen3-TTS inference acceleration.**
...
<!-- BENCH:SUMMARY:START -->
> __Hybrid (Faster+Triton)__ achieves __4.8x__ faster inference than PyTorch baseline at equivalent VRAM on RTX 5090.
<!-- BENCH:SUMMARY:END -->
...
graph TD
    ...
    C -->|"+Triton kernel fusion"| D["Hybrid (~5x)"]
...
| Mode | Latency (s) | RTF | Peak VRAM (GB) | vs Base |
|------|:-----------:|:---:|:--------------:|:-------:|
...
<!-- BENCH:QUALITY:START -->
Triton kernels produce statistically equivalent audio to the PyTorch baseline.

| Metric | Base | Triton | Delta | Threshold |
|--------|:----:|:------:|:-----:|:---------:|
